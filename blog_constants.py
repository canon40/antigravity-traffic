...
PRODUCT_KEYWORDS = {
    "auto": [
        "코팅제", "유리막코팅제", "자동차코팅제", "셀프 유리막 코팅", 
        "발수코팅", "광택", "차량관리", "자동차코팅", "유리막", "셀프코팅"
    ],
    "bike": [
        "바이크 코팅제", "오토바이 코팅제", "바이크코팅제", "오토바이 유리막 코팅", 
        "바이크 레진", "머플러 크롬 코팅", "배기 열 코팅", "바이크 발수", "바이크 디테일링"
    ],
    "living": [
        "듀라코트 리빙코트", "욕실코팅제", "타일코팅", "싱크대코팅",
        "가구 코팅", "발수코팅", "곰팡이억제", "가구코팅 추천"
    ],
}
